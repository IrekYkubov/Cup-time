    ...
    <footer className="footer">
      <div className="container footer__container">
        <a className="footer__logo-link">
          <img className="footer__logo" src="image/logo.svg" alt="Логотип" />
        </a>
        ...
        <div className="footer__info">
          ...
          <ul className="footer__developers">
            <li className="footer__developer">
              Designer: <a className="footer__developer-link" href="#">Anastasia Ilina</a>
            </li>
            <li className="footer__developer">
              Designer: <a className="footer__developer-link" href="#">Irek Yakubov</a>
            </li>
          </ul>
        </div>
